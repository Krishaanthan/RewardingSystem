    ...
    return (
        ...
        >
            ...
            <div className="flex items-center">
                <Link href="/admin-portal/dashboard" className="flex items-center">
            ...
            <div className="relative flex items-center" ref={dropdownRef}>
                ...
                >
                    ...
                    <span className="text-sm font-bold text-gray-800 tracking-wide">Admin</span>
                ...
                >
                    <div className="flex flex-col text-sm text-gray-700">
                        <Link
                            href="/admin-portal/admin-settings"
