          ...
          <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col gap-10 px-4 py-12 lg:flex-row lg:items-center lg:px-6">
            ...
            <div className="w-full max-w-md lg:ml-auto lg:self-stretch">
              <div className="relative">
                ...
                <div
                  className="relative rounded-[2rem] border border-white/20 bg-white/5 p-8 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(143,17,59,0.3)]"
                >
                  <div className="mb-6 space-y-1">
                    <p
                      className="text-xs font-black tracking-[0.28em]"
                      style={{ color: "#ff4d79", fontFamily: '"Archivo Black", system-ui, sans-serif' }}
                    >
                      FACULTY LOGIN
                    </p>
                    <h2
